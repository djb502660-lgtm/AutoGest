...
<div class="grid-2">
    ...
    <div class="panel" style="display:flex;flex-direction:column;height:520px;position:relative;">
        <div id="chatBody" style="flex:1;overflow-y:auto;display:flex;flex-direction:column;gap:10px;margin-bottom:12px;padding-right:4px;">
            ...
            @empty
                <div class="chat-msg bot" style="padding:10px 14px;border-radius:12px;font-size:0.88rem;background:rgba(8,15,29,0.9);align-self:flex-start;color:#f8fafc;">
¡Hola! 👋 Soy el asistente virtual de AutoGest. Puedes hacerme cualquier pregunta sobre el estado de tu vehículo, agendamiento de citas, reportes de mantenimiento o consultas de mecánica en general.
                </div>
            @endforelse
        ...
        <form id="chatForm" onsubmit="enviarMensaje(event)" style="display:flex;gap:8px;">
            ...
            <input 
                ...
                id="userInput" 
                class="input-field" 
                placeholder="Escribe tu consulta libremente..." 
                autocomplete="off"
                required
    ...
    <div class="panel" style="display:flex;flex-direction:column;gap:12px;">
        ...
        <div class="notif-item" style="cursor:pointer;padding:10px;border-radius:8px;background:rgba(15,23,42,0.6);margin-bottom:6px;" onclick="preguntarDirecto('¿Cómo va mi carro?')">
        ...
        <div class="notif-item" style="cursor:pointer;padding:10px;border-radius:8px;background:rgba(15,23,42,0.6);margin-bottom:6px;" onclick="preguntarDirecto('Mi carro hace un ruido cuando freno')">
        ...
        <div class="notif-item" style="cursor:pointer;padding:10px;border-radius:8px;background:rgba(15,23,42,0.6);margin-bottom:6px;" onclick="preguntarDirecto('Quiero agendar una cita')">
        ...
        <div class="notif-item" style="cursor:pointer;padding:10px;border-radius:8px;background:rgba(15,23,42,0.6);margin-bottom:6px;" onclick="preguntarDirecto('¿Tengo alguna cita?')">
        ...
        <div class="notif-item" style="cursor:pointer;padding:10px;border-radius:8px;background:rgba(15,23,42,0.6);margin-bottom:12px;" onclick="preguntarDirecto('Quiero cambiar mi cita')">
        ...
        <div class="notif-item" style="cursor:pointer;padding:10px;border-radius:8px;background:rgba(15,23,42,0.6);margin-bottom:12px;" onclick="preguntarDirecto('¿Cuánto he gastado este año?')">
        ...
        @if($faqs->isNotEmpty())
            ...
            @foreach ($faqs as $faq)
                <div class="notif-item" style="cursor:pointer;padding:8px;border-radius:6px;background:rgba(15,23,42,0.4);margin-bottom:4px;" onclick="preguntarDirecto(@js($faq->question))">
...
<script>
    ...
    function agregarMensaje(texto, remitente) {
        ...
        div.style.cssText = `padding:10px 14px;border-radius:12px;font-size:0.88rem;max-width:85%;white-space:pre-line;word-break:break-word;line-height:1.45;${
            remitente === 'user' 

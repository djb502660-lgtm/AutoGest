...
@section('title', 'Nueva preorden')
@section('heading', 'Nueva preorden')
@section('subheading', 'Registra una nueva preorden manual.')

@section('content')
    <div class="panel">
        <form method="POST" action="{{ route('advisor.pre-orders.store') }}">
            @csrf
